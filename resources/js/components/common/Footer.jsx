...
export default function Footer() {
    return (
        <>   <footer className="bg-gradient-to-r from-emerald-700 to-teal-800 text-white py-12">
            <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">

                {/* Brand / About */}
                <div>
                    <h4 className="text-xl font-semibold mb-4">EduFit</h4>
                    <p className="text-emerald-100 text-sm leading-relaxed">
                        EduFit provides quality school and university uniforms with
                        customization options, making ordering simple, fast, and reliable.
                    </p>
                </div>
            ...
            {/* Bottom Bar */}
            <div className="mt-10 border-t border-emerald-500/30 pt-4 text-center text-sm text-emerald-100">
